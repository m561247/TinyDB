...
CREATE TABLE Conn (ConnID int PRIMARY KEY, Name varchar(20));

CREATE TABLE Conn2 (ConnID int, Name varchar(20));
...
INSERT INTO Conn VALUES (9, 'Conn_9'), (19, 'Conn_19'), (5, 'Conn_5'), (8, 'Conn_8');

INSERT INTO Conn2 VALUES (9, 'Conn2_9'), (19, 'Conn2_19'), (5, 'Conn2_5'), (8, 'Conn2_8');

INSERT INTO Persons VALUES (4, 'Person_4'), (5, 'Person_5'), (6, 'Person_6'), (8, 'Person_8');
