...
namespace Protocol {
    ...
    uint8_t ReadU8(std::vector< uint8_t >& packet, std::vector< uint8_t>::iterator& it) {
    ...
    uint16_t ReadU16(std::vector< uint8_t >& packet, std::vector< uint8_t>::iterator& it) {
        // packet end check, TODO
        uint16_t v;
    ...
    uint16_t ReadU24(std::vector< uint8_t >& packet, std::vector< uint8_t>::iterator& it) {
        uint32_t v;
    ...
    uint32_t ReadU32(std::vector< uint8_t >& packet, std::vector< uint8_t>::iterator& it) {
        // packet end check, TODO
        uint32_t v;
        v = static_cast< uint32_t >(*it) |
            static_cast< uint32_t >(*(it + 1) << 8) |
    ...
    uint64_t ReadU64(std::vector< uint8_t >& packet, std::vector< uint8_t>::iterator& it) {
        // packet end check, TODO
        uint64_t v;
    ...
    uint64_t ReadLenEncode(std::vector< uint8_t >& packet, std::vector< uint8_t>::iterator& it) {
        uint8_t u8;
        uint16_t u16;
        uint32_t u24;
        uint64_t v;
    ...
    std::string ReadString(std::vector< uint8_t >& packet, std::vector< uint8_t>::iterator& it, size_t readBytes) {
        // is it to end todo
    ...
    std::string ReadLenEncodeString(std::vector< uint8_t >& packet, std::vector< uint8_t>::iterator& it) {
        uint64_t strLen;
