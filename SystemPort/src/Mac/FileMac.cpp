...
namespace SystemAbstractions {
    ...
    std::string File::GetLocalPerUserConfigDirectory(const std::string& nameKey) {
        return CppStringPlus::sprintf("%s/Library/Application Support/%s", GetUserHomeDirectory().c_str(), nameKey.c_str());
    }

    std::string File::GetUserSavedGamesDirectory(const std::string& nameKey) {
        return CppStringPlus::sprintf("%s/Library/Application Support/%s/Saved Games", GetUserHomeDirectory().c_str(), nameKey.c_str());
    }
