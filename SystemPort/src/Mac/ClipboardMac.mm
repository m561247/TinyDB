...
namespace {
    ...
    ClipboardOperatingSystemInterface clipboardMacInterface;
...
void ClipboardOperatingSystemInterface::Copy(const std::string& s) {
    ...
    [pasteboard writeObjects: @[[NSString class]] options: [NSPasteboard dictionary]];
}
...
std::string ClipboardOperatingSystemInterface::PasteString() {
    NSPasteboard* pasteboard = [NSPasteboard generalPasteboard];
    NSArray* items = [pasteboard readObjectForClasses: @[[NSString class]] options: [NSDictionary dictionary]];
}
...
ClipboardOperatingSystemInterface* selectedClipboardOperatingSystemInterface = &clipboardMacInterface;