...
namespace SystemAbstractions {
    ...
    public:
         ...
         * 
         * @param[in] minLevel
         *      This is the minmum level of message that this subscriber
         *      desires to receive
         * 
         * @return
         ...
         *  
         *  @param[in] peerPort
         *      This is the part number of the peer
         * 
         *  @return
         ...
         *  listening for incoming messages and sending outgoing message
         *  
         ...
         *      
         *  @return
         *      A indication of whether ot not the method was
         *      successful is broken.
         */
         ...
         *      is a connection currently established with a peer is returned.
         */
        virtual bool IsConnected() const = 0;

        /** 
         *  This method returns the IPv4 address that the connection object is using
         ...
         *      any data transmission still int progress, before breaking
         *      the connection.
         */
